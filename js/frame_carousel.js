...
function checkPosition2(position2) {
    if(window.innerWidth>767){
        ...
        switch(position2) {
            case 0:
			document.querySelector("#but_arrow_up2").style.display="none";
            document.querySelector("#but_arrow_down2").style.display="block";
            break;
            case 3: 
			document.querySelector("#but_arrow_down2").style.display="none";
            document.querySelector("#but_arrow_up2").style.display="block";
            break;
            default: document.querySelectorAll(".but_arrows_carousel").forEach(el=>el.style.display="block");
            break;
        }
